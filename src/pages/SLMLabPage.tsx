        ...
        {injectionZones.length > 0 && (
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="py-3 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                <span className="text-primary font-medium">Nothing added. Everything expanded.</span> {injectionPerspectives.length} perspective burners x {Math.max(3, Math.round(injectionIntensity * 4))} rounds = ~{injectionPerspectives.length * Math.max(3, Math.round(injectionIntensity * 4))}x cognitive expansion. 
