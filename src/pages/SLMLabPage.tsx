  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4 space-y-6 animate-fade-in">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground -mt-1">
          Before unlearning, <span className="text-primary font-medium">probe what the model currently knows</span>. 
          Send diagnostic prompts to map its knowledge landscape — then target specific behaviors for removal.
        </p>
