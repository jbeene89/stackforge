    ...
    <div className="max-w-2xl mx-auto py-8 px-4 space-y-6 animate-fade-in">
      ...
      <div className="space-y-3">
        ...
        {(() => {
          ...
          const [probeResults, setProbeResults] = useState<{ prompt: string; response: string; flagged: boolean }[]>([]);
          ...
          const runProbe = async (prompt: string) => {
            setProbing(true);
            try {
              // Use the Inference Playground's Ollama endpoint if available
              ...
              setProbeResults(prev => [...prev, { prompt, response: data.response || "(empty)", flagged: false }]);
            } catch {
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            if (!r.flagged) {
                              // Extract a behavior description and add to unlearn targets
